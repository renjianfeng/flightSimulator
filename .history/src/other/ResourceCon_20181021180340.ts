    ...
    constructor(){
        ...
        gameScene={
            binarys:[
                ...
                {name:"win2", filePath:this.pathFirst+"src/Resource/gameScene/binarys/", fileName:"jb.mp3"},
            ...
            models:[
              ...
              /*   {name:"wheel", filePath:this.pathFirst+"src/Resource/gameScene/models/car2/", fileName:"wheel.babylon"},
                ...
                {name:"sm14", filePath:this.pathFirst+"src/Resource/gameScene/models/sm14/", fileName:"sm102.glb"},
            ],
            textures:[
                ...
                {name:"flare2", filePath:this.pathFirst+"src/Resource/gameScene/textures/", fileName:"flare2.jpg"},
