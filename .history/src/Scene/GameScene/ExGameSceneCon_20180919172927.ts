  ...
  /*   console.log( "this.rect2")
   ...
   // this.rect1.linkOffsetY = -50;
    ...
    protected beforeRender(){
        ...
        this.display.camera2.setTarget( this.display.cameraBox.absolutePosition);
        this.display.camera2.position= this.display.camera2Box.absolutePosition;
        var useTime;
 ...
 */
    ...
    private movePlayer():void{
       ...
       /*  console.log("this.display.cameraBox")
        ...
        //   this.display.camera3.cameraAcceleration=0.18*this.times
