...
export class ExGameSceneCon extends GameScenes{
        ...
        //if(this.moveForward){
          /*   if(this.moveLeft){
           ...
           // console.log(this.display.cameraBox.rotation.z)
            ...
            this.setMeshVal(this.scene.getMeshByName("右翼"),40+this.display.cameraBox.rotation.z*10)
    ...
    private setMeshVal(mesh,val){
        ...
        var _val=6/40*val*10

        console.log("_val")
        console.log(_val)
        this.scene.beginAnimation(mesh, _val, _val+0.001, false);
    }
