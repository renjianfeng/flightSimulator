...
export class ExGameSceneCon extends GameScenes{
    ...
    private movePlayer():void{
        ...
        //if(this.moveForward){
            if(this.moveLeft){
                this.display.cameraBox.rotation.y-=0.04
            ...
            forwards = new BABYLON.Vector3((Math.sin(character.rotation.y)) / this.speedCharacter, (Math.cos(character.rotation.y)) /gravity, (Math.cos(character.rotation.y)) / this.speedCharacter);
