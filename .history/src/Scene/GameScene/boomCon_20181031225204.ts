...
export class BoomCon{
    ...
    public init(display){
        ...
        //  this.particleeExhaust = new BABYLON.ParticleSystem("particles", 2000, this.scene);
           ...
           // Texture
           this.particleeExhaust.particleTexture = new BABYLON.Texture("https://raw.githubusercontent.com/PatrickRyanMS/BabylonJStextures/master/ParticleSystems/Explosion/ExplosionSim_Sample.png", scene);
    ...
    public boom(position){
        this.booms[this.ij].position=new BABYLON.Vector3(position.x,position.y,position.z);
            this.booms[this.ij].scaling.x=2;
            this.booms[this.ij].scaling.y=2;
            this.booms[this.ij].scaling.z=2;
            this.booms[this.ij].boom.to({ x:0.2 ,y:0.2,z:0.2}, 1000);
