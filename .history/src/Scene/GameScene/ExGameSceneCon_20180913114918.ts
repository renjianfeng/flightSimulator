...
export class ExGameSceneCon extends GameScenes{
    ...
    private setMeshVal(mesh,state,val){
       if(state=="up-go"){
            this.scene.beginWeightedAnimation(mesh, 0, 0.7916666865348816*val,0, false);
       }

       if(state=="up-back"){
            this.scene.beginWeightedAnimation(mesh, 0.7916666865348816, 1.625*val,0, false);
       }

       if(state=="down-do"){
            this.scene.beginWeightedAnimation(mesh, 1.625, 2.4583332538604736*val,0, false);
       }

       if(state=="down-back"){
            this.scene.beginWeightedAnimation(mesh, 2.4583332538604736, 3.2916667461395264*val,0, false);
       }
    }
