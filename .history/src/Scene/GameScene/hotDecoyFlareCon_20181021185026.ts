...
export class HotDecoyFlareCon{
    ...
    public init(display){
        ...
        this.creatMusic()
         ...
         this.particleeExhaust.color1 = new BABYLON.Color4(0, 0, 0, 1.0);
         this.particleeExhaust.color2 = new BABYLON.Color4(0, 0, 0, 1.0);
       ...
       //  particleeExhaust["addColorGradient"](0, new BABYLON.Color4(1, 1, 1, 0));
         ...
         this.particleeExhaust.blendMode = BABYLON.ParticleSystem.BLENDMODE_STANDARD;
         this.particleeExhaust.direction1 = new BABYLON.Vector3(-0.2, 0.8, -2.3);
         this.particleeExhaust.direction2 = new BABYLON.Vector3(0.2, 0.8, -2.3);
        ...
        // this.particleeExhaust2=this.particleeExhaust["clone"]("s",1)
         ...
         //粒子尾气的位置
         this.tailFlower.Position(new BABYLON.Vector3(0, 0, -0.5))
