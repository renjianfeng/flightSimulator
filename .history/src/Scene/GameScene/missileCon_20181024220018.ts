    ...
    public init(display){
        ...
        for(var i=0;i<=160;i++){
          ...
          //  missile.scaling=new BABYLON.Vector3(10,10,10)
            ...
            this.tailFlowers[i]=new particleCon(new BABYLON.Vector3(0,0,0),SceneManager.ins.scene, this.particleeExhaust);        
            //粒子尾气的位置
            this.tailFlowers[i].Position(new BABYLON.Vector3(0, 0, -0.6))
   
            this.tailFlowers[i].Parent(this.display.cameraBox);
        }
