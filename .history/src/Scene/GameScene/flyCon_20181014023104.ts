...
export class FlyCon{
   ...
   //   var ram=Math.random;
        ...
        if(this.obstacleCount==0){
           ...
           var _jl=Func.ins.getDistance(
            ...
            if(_jl<=100){
                ...
                this.warningText="注意地面撞击，距离"+_jl+"米";
            }
         ...
         if(this.obstacleCount==1){
            var _jl=Func.ins.getDistance(
                ...
                if(_jl<=100){
                    ...
                    this.warningText="注意上方撞击，距离"+_jl+"米";
                }
              // console.log("上方"+_jl)	
        }
          ...
          if(this.obstacleCount==2){
            var _jl=Func.ins.getDistance(
                ...
                if(_jl<=100){
                    ...
                    this.warningText="注意前方撞击，距离"+_jl+"米";
                }
              // console.log("前方"+_jl)		
        }
          ...
          if(this.obstacleCount==3){
            var _jl=Func.ins.getDistance(
                ...
                if(_jl<=100){
                    ...
                    this.warningText="注意左方撞击，距离"+_jl+"米";
                }
              // console.log("右方"+_jl)		
          }
          ...
          if(this.obstacleCount==4){
            var _jl=Func.ins.getDistance(
                ...
                if(_jl<=100){
                    ...
                    this.warningText="注意右方撞击，距离"+_jl+"米";
                }
               //console.log("左方"+_jl)			
          }
    ...
    private sayWarning(){
        ...
        setInterval(()=>{
            var msg = new SpeechSynthesisUtterance("注意地面撞击");
            console.log(msg);
