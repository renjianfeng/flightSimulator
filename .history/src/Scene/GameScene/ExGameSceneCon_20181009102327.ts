              ...
              //  var moveX = 0, moveY = 0;
                ...
                if(this.moveX*0.001>Math.PI*2){
                 ...
                 if(this.freeView==false){
                    ...
                    /*  this.display.camera3.detachControl(SceneManager.ins.canvas);
                   ...
                   //  this.eleImage.requestPointerLock();
                     ...
                     this.display.camera2.rotation.y=-this.moveX*0.001;
                     this.display.camera2.rotation.z=-this.moveY*0.001;
