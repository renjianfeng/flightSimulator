      ...
      /*  this.scene.fogMode = BABYLON.Scene.FOGMODE_EXP;
       ...
       /*  var light2 = new BABYLON.HemisphericLight("HemiLight", new BABYLON.Vector3(0, -10, 0), this.scene);
        ...
        // lens4.position=new BABYLON.Vector3(-300000, 10000, 0)
         ...
         var _lens4 = new BABYLON.LensFlare(0.6, 1.3, new BABYLON.Color3(1,1,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["lens"].src, lensFlareSystem4);
        
         var lens5 = BABYLON.Mesh.CreateSphere("centerHidenPick", 16, 0.1, this.scene);
         lens5.visibility=0
         lens5.position=new BABYLON.Vector3(-0.05,0.02,-0.5)
         lens5.parent=cameraBox;
         var lensFlareSystem5 = new BABYLON.LensFlareSystem("lensFlareSystem", lens5, this.scene);
         var _lens5 = new BABYLON.LensFlare(0.6, 1.3, new BABYLON.Color3(1,1,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["lens"].src, lensFlareSystem5);
