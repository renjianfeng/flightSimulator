...
export class ExGameScene{
    ...
    public creatScene(){
      ...
      /*   camera2.position.z=-3;
        ...
        skyboxMaterial.diffuseTexture =  AssetsManager.ins.resourceObject["texextures"]["gameScene"]["skybox13"].clone();
        skyboxMaterial.emissiveTexture =  AssetsManager.ins.resourceObject["texextures"]["gameScene"]["skybox13"].clone();
