...
export class ExGameSceneCon extends GameScenes{
    ...
    private setMeshVal(mesh,val){
       if(val=="up-go"){
            this.scene.beginWeightedAnimation(mesh, 0, 0.7916666865348816,1.0, false);
       }

       if(val=="up-back"){
            this.scene.beginWeightedAnimation(mesh, 0.7916666865348816, 1.625,1.0, false);
       }

       if(val=="down-do"){
            this.scene.beginWeightedAnimation(mesh, 1.625, 2.4583332538604736,1.0, false);
       }

       if(val=="down-back"){
            this.scene.beginWeightedAnimation(mesh, 2.4583332538604736, 3.2916667461395264,1.0, false);
       }
    }
