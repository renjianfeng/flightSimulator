            ...
            　if (e.keyCode == 82) {
                ...
                if(_qljstate){
                  ...
                  /*   qlj1.play()
                    ...
                    qlj3.play()
 */
                    this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"),  0.7916666865348816,0,0, true);
                    this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"),  0.7916666865348816,0,0, true);
                    this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"),  0.7916666865348816,0,0, true);
                   ...
                   this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"), 0, 0.7916666865348816,0, true);
                   this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"), 0, 0.7916666865348816,0, true);
                   this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"), 0, 0.7916666865348816,0, true);
