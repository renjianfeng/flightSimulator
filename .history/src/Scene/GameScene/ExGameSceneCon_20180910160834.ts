...
export class ExGameSceneCon extends GameScenes{
    ...
    protected resetGame(){
       ...
       // alert()
        ...
        this.scene.beginAnimation(this.scene.skeletons[0], 5,5.001, false);
       /*  setTimeout(()=>{
    ...
    protected beforeRender(){
       // console.log(1144)
        ...
        /* this.scene.beginAnimation(this.scene.skeletons[0], this.display.camera.beta/Math.PI*2+1, this.display.camera.beta/Math.PI*2+1+0.001, false);
        this.scene.beginAnimation(this.scene.skeletons[0], this.display.camera.beta/Math.PI*2+1, this.display.camera.beta/Math.PI*2+1+0.001, false);
        this.scene.beginAnimation(this.scene.skeletons[0], this.display.camera.beta/Math.PI*2+1, this.display.camera.beta/Math.PI*2+1+0.001, false);
        this.scene.beginAnimation(this.scene.skeletons[0], this.display.camera.beta/Math.PI*2+1, this.display.camera.beta/Math.PI*2+1+0.001, false);
 */
