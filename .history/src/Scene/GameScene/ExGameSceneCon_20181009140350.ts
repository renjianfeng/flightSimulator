   ...
   // this.rect1.linkOffsetY = -50;
     ...
     /*    var hit = scene.pickWithRay(ray);
      ...
      //  this.scene.getMeshByName("default").material=this.display.terrainMaterial
        this.scene.getMeshByName("TerrainMesh007").isPickable=true;
        this.scene.getMeshByName("TerrainMesh006").isPickable=true;
        this.scene.getMeshByName("TerrainMesh005").isPickable=true;
        this.scene.getMeshByName("TerrainMesh004").isPickable=true;
        this.scene.getMeshByName("TerrainMesh003").isPickable=true;
        this.scene.getMeshByName("TerrainMesh002").isPickable=true;
        this.scene.getMeshByName("TerrainMesh001").isPickable=true;
        this.scene.getMeshByName("TerrainMesh").isPickable=true;
       // this.scene.getMeshByName("Terrain002").scaling=new BABYLON.Vector3(1000,1000,1000);
 ...
 */
    ...
    private movePlayer():void{
        ...
        if(this.freeView==false){
            ...
            this.display.camera2.rotation=new BABYLON.Vector3(0,-Math.PI*2,0)
