...
export class ExGameSceneCon extends GameScenes{
    ...
    private freeUpdate() {
        ...
        this.frees.forEach((free)=>{
            if(free.lifeState==true){
                var forword=new BABYLON.Vector3(free.forward.x*20,free.forward.y*20,free.forward.z*20)
    ...
    private movePlayer():void{
       ...
       /*  console.log("this.display.cameraBox")
        ...
        if(this.display.cameraBox.rotation.z>Math.PI){
              this.display.cameraBox.rotation.z=0
           }

           if(this.display.cameraBox.rotation.z<0){
            this.display.cameraBox.rotation.z=Math.PI
         }

          // this.display.cameraBox.rotation.z=this.display.cameraBox.rotation.z%(Math.PI*2);
