  ...
  //  this.ico_b.top="-192px";
   ...
   //   var ram=Math.random;
    ...
    private keyevent():void{
        ...
        var qlj1=this.scene.beginAnimation(this.scene.getMeshByName("前轮"), 0, 0.7916666865348816, true);
        var qlj2=this.scene.beginAnimation(this.scene.getMeshByName("后轮"), 0, 0.7916666865348816, true);
        var qlj3=this.scene.beginAnimation(this.scene.getMeshByName("后轮.001"), 0, 0.7916666865348816, true);

        var qlj1_2=this.scene.beginAnimation(this.scene.getMeshByName("前轮"),  0.7916666865348816,1.625, true);
        var qlj2_2=this.scene.beginAnimation(this.scene.getMeshByName("后轮"),  0.7916666865348816,1.625, true);
        var qlj3_2=this.scene.beginAnimation(this.scene.getMeshByName("后轮.001"),  0.7916666865348816,1.625, true);
