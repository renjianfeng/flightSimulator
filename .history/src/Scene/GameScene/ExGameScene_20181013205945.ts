      ...
      /*  this.scene.fogMode = BABYLON.Scene.FOGMODE_EXP;
       ...
       /*  var light2 = new BABYLON.HemisphericLight("HemiLight", new BABYLON.Vector3(0, -10, 0), this.scene);
        ...
        // lens4.position=new BABYLON.Vector3(-300000, 10000, 0)
         ...
         var _lens4 = new BABYLON.LensFlare(1.6, 1.3, new BABYLON.Color3(1,1,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["lens"].src, lensFlareSystem4);
         ...
         var _lens5 = new BABYLON.LensFlare(1.6, 1.3, new BABYLON.Color3(1,1,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["lens"].src, lensFlareSystem5);
