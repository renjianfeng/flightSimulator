...
export class ExGameSceneCon extends GameScenes{
    ...
    protected resetGame(){
      ...
      //  this.scene.getMeshByName("default").material=this.display.terrainMaterial
	    ...
	    renderTargetTexture.activeCamera = this.display.camera3;
        renderTargetTexture.renderList.push(this.scene.getMeshByName("default"),this.display.skySphere);
        
        this.display.jingzi.material = new BABYLON.StandardMaterial("jingzi", scene);
        this.display.jingzi.material.emissiveTexture = renderTargetTexture;
        this.display.jingzi.material.reflectionTexture = renderTargetTexture;
