...
export class CarCon {
     ...
     * @state 车灯状态
     * */
    public setCarLight(state):void{
        if(state){
            this.display.light4.intensity=10;
            this.scene.getMeshByName("Jeep GC-P 25").material.emissiveColor.level=1;
            ...
            this.scene.getMeshByName("Jeep GC-P 25").material.emissiveColor.level=0.1;
