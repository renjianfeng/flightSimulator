...
export class ExGameSceneCon extends GameScenes{
    ...
    protected beforeRender(){
       // console.log(1144)
        //this.display.cameraBox.rotation.y=-this.display.camera.alpha-Math.PI*0.4;
      //  console.log(this.display.camera.beta/Math.PI)

        console.log(Math.PI-this.display.camera.beta/Math.PI*4)

/* 
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_Head"), Math.PI-this.display.camera.beta/Math.PI*4+2, Math.PI-this.display.camera.beta/Math.PI*4+2+0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_L Arm"), Math.PI-this.display.camera.beta/Math.PI*4+2, Math.PI-this.display.camera.beta/Math.PI*4+2+0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_R Arm"), Math.PI-this.display.camera.beta/Math.PI*4+2, Math.PI-this.display.camera.beta/Math.PI*4+2+0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_Bone"), Math.PI-this.display.camera.beta/Math.PI*4+2, Math.PI-this.display.camera.beta/Math.PI*4+2+0.001, false);
 */
