  ...
  //  this.ico_b.top="-192px";
   ...
   //   var ram=Math.random;
    ...
    private keyevent():void{
        ...
        var qlj1=this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"), 0, 20,0, false);
        var qlj2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"), 0, 20,0, false);
        var qlj3=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"), 0, 20,0, false);

        var qlj1_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"),  20,40,0, false);
        var qlj2_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"),  20,40,0, false);
        var qlj3_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"),  20,40,0, false);
