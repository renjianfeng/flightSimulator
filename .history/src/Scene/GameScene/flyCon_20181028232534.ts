  ...
  //  this.ico_b.top="-192px";
   ...
   //   var ram=Math.random;
    ...
    private keyevent():void{
        ...
        var qlj1=this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"), 0, 0.7916666865348816,0, false);
        var qlj2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"), 0, 0.7916666865348816,0, false);
        var qlj3=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"), 0, 0.7916666865348816,0, false);

        var qlj1_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"),  0.7916666865348816,0,0, false);
        var qlj2_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"),  0.7916666865348816,0,0, false);
        var qlj3_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"),  0.7916666865348816,0,0, false);
            ...
            　if (e.keyCode == 82) {
                ...
                if(_qljstate){
                  ...
                  /*   qlj1.play()
                    ...
                    qlj3.play()
 */
                    this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"),  0.7916666865348816,0,0, false);
                    this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"),  0.7916666865348816,0,0, false);
                    this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"),  0.7916666865348816,0,0, false);
                   ...
                   this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"), 0, 0.7916666865348816,0, false);
                   this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"), 0, 0.7916666865348816,0, false);
                   this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"), 0, 0.7916666865348816,0, false);
