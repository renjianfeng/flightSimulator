...
export class ExGameSceneCon extends GameScenes{
    ...
    protected beforeRender(){
       // console.log(1144)
        ...
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_Head"), 0, 0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_L Arm"), 0, 0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_R Arm"), 0, 0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_Bone"), 0, 0.001, false);
