...
export class FlyCon{
   ...
   // AssetsManager.ins.resourceObject["images"]["gameScene"]["jiantou"].clone()
    ...
    var tipsBg = new BABYLON.GUI.Rectangle();
   ...
   // this.rect1.cornerRadius = 5;
    ...
    tipsBg.top="20px"
    tipsBg.thickness =1;
    tipsBg.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;
    tipsBg.horizontalAlignment = BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER; 
