  ...
  //  this.ico_b.top="-192px";
   ...
   //   var ram=Math.random;
    ...
    private keyevent():void{
        ...
        var qlj1_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("前轮"),  0.7916666865348816,0,0, true);
        var qlj2_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮"),  0.7916666865348816,0,0, true);
        var qlj3_2=this.scene.beginWeightedAnimation(this.scene.getMeshByName("后轮.001"),  0.7916666865348816,0,0, true);
