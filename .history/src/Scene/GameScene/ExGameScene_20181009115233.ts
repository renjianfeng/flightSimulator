...
export class ExGameScene{
    ...
    public creatScene(){
         ...
         * 室内相机
         * */
        var camera2 = new BABYLON.UniversalCamera("UniversalCamera", new BABYLON.Vector3(0, 0.112, 0.30), this.scene);
        camera2.speed=4;
        camera2.inertia=0;
 ...
 */
      ...
      /*  this.scene.fogMode = BABYLON.Scene.FOGMODE_EXP;
        ...
        light3.shadowFrustumSize=60
        light3.shadowMinZ=-30
        light3.shadowMaxZ=30
