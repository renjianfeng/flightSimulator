        ...
        this.musics={
            zhanji:new BABYLON.Sound("zhanji",[AssetsManager.ins.resourceObject["binarys"]["gameScene"]["zhanji"]["url"]] , this.scene,()=>{
               ...
               // this.musics.zhanji.setVolume(0.5)
                this.musics.zhanji._startTime=30
                console.log("this.musics.zhanji")
                console.log(this.musics.zhanji)
               // console.log(this.musics.zhanji.connectToSoundTrackAudioNode)
             //  var ss=this.musics.zhanji.connectToSoundTrackAudioNode()
                SceneManager.ins.scene.onBeforeRenderObservable.add(()=>{
                  //  console.log(this.musics.zhanji._soundGain.context.currentTime)
                   /*  console.log(this.musics.zhanji._coneOuterGain)
                    console.log(this.musics.zhanji.rolloffFactor)
                    console.log(this.musics.zhanji.soundTrackId) */
               //     console.log(ss) 
                    console.log(this.musics.zhanji.currentTime) 
                    if(this.musics.zhanji._soundGain.context.currentTime>=10){
                        this.musics.zhanji._soundGain["context.currentTime"]=6;
                    }
