...
export class HotDecoyFlareCon{
    ...
    private creatMusic(){
        this.musics={
            qiang:new BABYLON.Sound("daodan",[AssetsManager.ins.resourceObject["binarys"]["gameScene"]["qiang2"]["url"]] , this.scene,()=>{
    ...
    public init(display){
     ...
     //   this.scene.getMeshByName("导弹").isVisible=false;
        ...
        //创建子弹列表
        for(var i=0;i<=10;i++){
            this.bullets[i]= BABYLON.MeshBuilder.CreateSphere("frees", {diameterX:  10, diameterY: 10, diameterZ: 10}, this.scene);
