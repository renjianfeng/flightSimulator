...
export class ExGameSceneCon extends GameScenes{
    ...
    private movePlayer():void{
        ...
        //if(this.moveForward){
            ...
            forwards = new BABYLON.Vector3((Math.sin(character.rotation.y)) / this.speedCharacter, (Math.sin(character.rotation.x)), (Math.cos(character.rotation.y)) / this.speedCharacter);
