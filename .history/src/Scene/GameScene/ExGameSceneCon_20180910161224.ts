...
export class ExGameSceneCon extends GameScenes{
    ...
    protected beforeRender(){
      ...
      //  this.display.cameraBox.rotation.y=-this.display.camera.alpha-Math.PI*0.5;
        ...
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_Head"), this.display.camera.beta/Math.PI*4+2, this.display.camera.beta/Math.PI*4+2+0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_L Arm"), this.display.camera.beta/Math.PI*4+2, this.display.camera.beta/Math.PI*4+2+0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_R Arm"), this.display.camera.beta/Math.PI*4+2, this.display.camera.beta/Math.PI*4+2+0.001, false);
        this.scene.beginAnimation(this.scene.getBoneByName("Kości medyk_Bone"), this.display.camera.beta/Math.PI*4+2, this.display.camera.beta/Math.PI*4+2+0.001, false);
