...
export class MissileCon{
    ...
    public init(display){
        ...
        //创建子弹列表
        for(var i=0;i<=160;i++){
            this.bullets[i]= BABYLON.MeshBuilder.CreateSphere("frees", {diameterX:  0.1, diameterY: 0.1, diameterZ: 0.1}, this.scene);
            ...
            missile.posotion=new BABYLON.Vector3(0,0,0)
          //  missile.scaling=new BABYLON.Vector3(10,10,10)
            ...
            missile.scaling=new BABYLON.Vector3(1,1,1)
        }
