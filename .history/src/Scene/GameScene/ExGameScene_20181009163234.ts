      ...
      /*  this.scene.fogMode = BABYLON.Scene.FOGMODE_EXP;
       ...
       /*  var light2 = new BABYLON.HemisphericLight("HemiLight", new BABYLON.Vector3(0, -10, 0), this.scene);
        ...
        terrainMaterial.diffuseTexture3.vScale=20
         ...
         var flare00 = new BABYLON.LensFlare(1.5, 0.3, new BABYLON.Color3(1,1,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["ty"].src, lensFlareSystem3);
         var flare01 = new BABYLON.LensFlare(0.24, 0.2, new BABYLON.Color3(0,1,0), AssetsManager.ins.resourceObject["images"]["gameScene"]["Bphl4qj"].src, lensFlareSystem3);
         var flare02 = new BABYLON.LensFlare(0.28, 0.3, new BABYLON.Color3(0,0,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["Bphl4qj"].src, lensFlareSystem3);
         var flare03 = new BABYLON.LensFlare(0.2, 0.4, new BABYLON.Color3(.5,.7,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["IIyZhcg"].src, lensFlareSystem3);
         var flare04 = new BABYLON.LensFlare(0.2, 0.3, new BABYLON.Color3(.5,.5,1), AssetsManager.ins.resourceObject["images"]["gameScene"]["HRsf4I5"].src, lensFlareSystem3);
