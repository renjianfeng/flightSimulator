    ...
    private movePlayer():void{
        ...
        //if(this.moveForward){
            ...
            forwards = new BABYLON.Vector3(
                ...
                -(Math.sin(character.rotation.x))*(Math.cos(character.rotation.z))*(Math.cos(character.rotation.y))/ this.speedCharacter, 
                (Math.cos(character.rotation.y))*(Math.cos(character.rotation.x))*(Math.sin(character.rotation.z))/ this.speedCharacter
            );
