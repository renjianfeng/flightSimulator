            ...
            if(this.freeState){
               ...
               // this.musics.qiang.setVolume(1)
                ...
                if(this.j<=this.bullets.length-1){
                    ...
                    this.bullets[this.j].rotation=new BABYLON.Vector3(this.display.cameraBox.rotation.x+ram+(Math.PI*0.5),this.display.cameraBox.rotation.y+ram,this.display.cameraBox.rotation.z);
