    ...
    private movePlayer():void{
        ...
        //if(this.moveForward){
            ...
            forwards = new BABYLON.Vector3(
                (Math.sin(character.rotation.y)) / this.speedCharacter*(Math.cos(character.rotation.z)), 
                -(Math.sin(character.rotation.x)) / this.speedCharacter*(Math.cos(character.rotation.z)), 
                (Math.cos(character.rotation.y)) / this.speedCharacter*(Math.cos(character.rotation.x))
            );
