...
export class HotDecoyFlareCon{
    ...
    public init(display){
        ...
        this.creatMusic()
         ...
         //尾气粒子
         this.particleeExhaust = new BABYLON.ParticleSystem("particles", 10, this.scene);
         //粒子的纹理
       ...
       //  particleeExhaust["addColorGradient"](0, new BABYLON.Color4(1, 1, 1, 0));
         ...
         this.particleeExhaust.minLifeTime = 30;
         this.particleeExhaust.maxLifeTime = 30;
         this.particleeExhaust.emitRate = 50;
         this.particleeExhaust.blendMode = BABYLON.ParticleSystem.BLENDMODE_ONEONE;
         this.particleeExhaust.direction1 = new BABYLON.Vector3(-0.2, 0.4, -1);
         this.particleeExhaust.direction2 = new BABYLON.Vector3(0.2, 0.4, -1);
