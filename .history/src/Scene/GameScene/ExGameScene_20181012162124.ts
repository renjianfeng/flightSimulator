     ...
     // BABYLON.SceneOptimizer.OptimizeAsync(this.scene, BABYLON.SceneOptimizerOptions.HighDegradationAllowed())
      ...
      /*   camera2.position.z=-3;
       ...
       // camera3.viewport = new BABYLON.Viewport(0, 0, 1.0, 1.0);
        camera4.viewport = new BABYLON.Viewport(0, 0.7, 0.3, 0.3);
        camera5.viewport = new BABYLON.Viewport(0.7, 0.7, 0.3, 0.3);
