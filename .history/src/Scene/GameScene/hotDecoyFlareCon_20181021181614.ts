...
export class HotDecoyFlareCon{
    ...
    public init(display){
        ...
        this.creatMusic()
         ...
         //粒子的纹理
         this.particleeExhaust.particleTexture = AssetsManager.ins.resourceObject["textures"]["gameScene"]["boom"].clone();
       ...
       //  particleeExhaust["addColorGradient"](0, new BABYLON.Color4(1, 1, 1, 0));
         ...
         this.particleeExhaust.direction1 = new BABYLON.Vector3(0.3, 0, -0.9);
         this.particleeExhaust.direction2 = new BABYLON.Vector3(-0.3, 0, -0.9);
