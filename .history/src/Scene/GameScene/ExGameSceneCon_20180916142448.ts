...
export class ExGameSceneCon extends GameScenes{
   ...
   // this.rect1.cornerRadius = 5;
    ...
    this.rect3.width = "90px";
    this.rect3.height = "3600px";
    this.rect3.top="-50%";
    //this.rect1.cornerRadius = 5;
        ...
        //   console.log(this.scene.meshes)
           ...
           this.rect2.rotation=-this.display.cameraBox.rotation.z;
            ...
            if(this.display.cameraBox.rotation.x>Math.PI*2){
             ...
             console.log(-50+(50*this.display.cameraBox.rotation.x/(Math.PI*2))+"%")

             //this.rect3.top=-50+(50*this.display.cameraBox.rotation.x/(Math.PI*2))+"%";
             this.rect3.top="-100%";
