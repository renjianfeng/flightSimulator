      ...
      private barrierCon(barrierConState){
        ...
        if(barrierConState){
            this.barrierConTime=setInterval(()=>{ 
                ...
                this.scene.getMeshByName("锥体.003").isVisible=!this.scene.getMeshByName("锥体.003").isVisible;
                this.scene.getMeshByName("锥体.003_0").isVisible=!this.scene.getMeshByName("锥体.003_0").isVisible;
                this.scene.getMeshByName("锥体.003_1").isVisible=!this.scene.getMeshByName("锥体.003_1").isVisible;
                this.scene.getMeshByName("锥体.003_2").isVisible=!this.scene.getMeshByName("锥体.003_2").isVisible;
                this.scene.getMeshByName("锥体.003_3").isVisible=!this.scene.getMeshByName("锥体.003_3").isVisible;
                this.scene.getMeshByName("锥体.003_4").isVisible=!this.scene.getMeshByName("锥体.003_4").isVisible;
                this.scene.getMeshByName("锥体.003_5").isVisible=!this.scene.getMeshByName("锥体.003_5").isVisible;
                this.scene.getMeshByName("锥体.003_6").isVisible=!this.scene.getMeshByName("锥体.003_6").isVisible;
             //   this.scene.getMeshByName("气流2").isVisible=!this.scene.getMeshByName("气流2").isVisible;
            },30)
        }else{
            this.scene.getMeshByName("锥体.003").isVisible=false;
            //this.scene.getMeshByName("气流2").isVisible=false;
        }
