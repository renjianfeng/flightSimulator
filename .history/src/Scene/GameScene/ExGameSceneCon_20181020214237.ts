...
var glass = BABYLON.MeshBuilder.CreatePlane("glass", {width: 10000000, height: 10000000}, scene);
glass.position = new BABYLON.Vector3(0,0, -10000);
...
mirrorMaterial.reflectionTexture["renderList"] = [ this.scene.getMeshByName("default")];
