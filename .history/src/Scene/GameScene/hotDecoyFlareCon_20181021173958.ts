    ...
    public update(times) {
         ...
         this.bullets.forEach((free,i)=>{
             if(free.lifeState==true){
                k+=0.1
                 var forword=new BABYLON.Vector3(free.forward.x*this.times*this.fireSpeed*k,free.forward.y*this.times*this.fireSpeed*k,free.forward.z*this.times*this.fireSpeed*k)
