...
export class ExGameScene{
    ...
    public creatScene(){
      ...
      //  this.scene.activeCamera=camera2;
         ...
         * 室内相机
         * */
        var camera4 = new BABYLON.UniversalCamera("UniversalCamera", new BABYLON.Vector3(0, 0.152, 0.30), this.scene);
      ...
      //  camera4.upVector = new BABYLON.Vector3(-1,-1, -3);
        ...
        var camera5 = new BABYLON.UniversalCamera("UniversalCamera", new BABYLON.Vector3(0, 0.112, 0.3), this.scene);
