...
export class ExGameSceneCon extends GameScenes{
   ...
   // this.rect1.cornerRadius = 5;
    ...
    this.rect3.horizontalAlignment = BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;
    //this.rect1.cornerRadius = 5;
         ...
         // this.display.camera3.speed=2*this.times;
           this.rect2.rotation=-this.display.cameraBox.rotation.z;
            ...
            if(this.moveY>=50||this.moveY<=-50){
                ...
                this.display.camera2.rotation.x=-this.moveY/40000*5
                this.display.camera2.position.y=this.moveY/40000*10+0.3
            }


            this.display.camera2.rotation.y=-this.display.cameraBox.rotation.z/10
            this.display.camera2.position.x=-this.display.cameraBox.rotation.z
