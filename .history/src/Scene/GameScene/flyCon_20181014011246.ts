...
export class FlyCon{
    ...
    private creatMusic(){
        this.musics={
            ...
            },{loop:true,panningModel:"HRTF",spatialSound: true}),
       ...
       /*  this.character.ellipsoid = new BABYLON.Vector3(3,6, 3);
        ...
        var forwards
           ...
           this.rect3.top=(-1460-1800*this.display.cameraBox.rotation.x/(Math.PI*2))+"px";
            ...
            this.display.camera2.position=new BABYLON.Vector3(
                this.display.cameraBox.position.x-0,
                this.display.cameraBox.position.y+0.112,
                this.display.cameraBox.position.x-0.31,
            ) 
           // = new BABYLON.UniversalCamera("UniversalCamera", new BABYLON.Vector3(0, 0.112, -0.31), this.scene);
           // camera2.speed=40;
           // camera2.inertia=0;
           // camera2.position=cameraBox.position;
