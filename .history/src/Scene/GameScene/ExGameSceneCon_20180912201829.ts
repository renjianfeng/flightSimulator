    ...
    private movePlayer():void{
        ...
        //if(this.moveForward){
          ...
          /*   forwards = new BABYLON.Vector3(
                (Math.sin(character.rotation.y))*(Math.cos(character.rotation.z))*(Math.abs(character.rotation.x))/ this.speedCharacter, 
                (Math.sin(character.rotation.x))*(Math.cos(character.rotation.z))*(Math.abs(character.rotation.y))/ this.speedCharacter, 
                (Math.cos(character.rotation.y))*(Math.cos(character.rotation.x))*(Math.abs(character.rotation.z))/ this.speedCharacter
            ); */

            character.moveWithCollisions(character.rotation);
