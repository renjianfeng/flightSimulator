    ...
    public addEvent(){
        ...
        this.doEvents["MAP_LIST"]==document.getElementById("MAP_LIST").addEventListener("change",(e)=>{
         ...
         // localStorage.car={x:2,y:0,z:0};
          ...
          if(_map.map=="1"){
            document.getElementById("MAP_LIST").style.backgroundImage="url("+AssetsManager.ins.resourceObject["images"]["gameScene"]["b1"].src+")"
          }

          if(_map.map=="2"){
            document.getElementById("MAP_LIST").style.backgroundImage="url("+AssetsManager.ins.resourceObject["images"]["gameScene"]["b2"].src+")"
          }
