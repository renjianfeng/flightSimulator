    ...
    public addEvent(){
        ...
        this.doEvents["MAP_LIST"]==document.getElementById("MAP_LIST").addEventListener("change",(e)=>{
         ...
         var _map=eval('(' + (document.getElementById("MAP_LIST")["value"]) + ')');
          ...
          localStorage.carposition={x:2,y:0,z:0};
          localStorage.carposition.x=_map.carposition.x;
          localStorage.carposition.y=_map.carposition.y;
          localStorage.carposition.z=_map.carposition.z;

          console.log(_map.carposition)
          
          console.log(localStorage.carposition)
        })
