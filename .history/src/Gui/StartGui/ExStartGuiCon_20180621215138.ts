...
export class ExStartGuiCon extends StartGui{
    ...
    public addEvent(){
        ...
        this.doEvents["MAP_LIST"]==document.getElementById("MAP_LIST").addEventListener("change",(e)=>{
          localStorage.map=document.getElementById("MAP_LIST")["value"];
          console.log(e)
          console.log(document.getElementById("MAP_LIST")["value"])
          console.log(JSON.parse(document.getElementById("MAP_LIST")["value"]))
        })
